...
You can run App in your local by using datsets ([dataset1](https://www.kaggle.com/datasets/vishweshsalodkar/wild-animals), [dataset2](https://www.kaggle.com/datasets/ikarus777/best-artworks-of-all-time)), [models](/src) and [streamlit App](/app)} in the repo.
