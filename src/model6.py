...
class ConvEncoder(nn.Module):
    ...
    def __init__(self):
        ...
        self.maxpool4 = nn.MaxPool2d((3, 3),stride=2)
        ...
        self.maxpool6 = nn.MaxPool2d((3, 3),stride=2)
...
class ConvDecoder(nn.Module):
    ...
    def __init__(self):
        ...
        self.deconv1 = nn.ConvTranspose2d(1024, 512, (3,3),output_padding=1,stride=(2, 2))
        # self.upsamp1 = nn.UpsamplingBilinear2d(2)
        self.relu1 = nn.ReLU(inplace=True)
        
        self.deconv2 = nn.ConvTranspose2d(512, 512, (3, 3),stride=(2, 2))
        # self.upsamp1 = nn.UpsamplingBilinear2d(2)
        self.relu2 = nn.ReLU(inplace=True)

        self.deconv3 = nn.ConvTranspose2d(512, 256, (3, 3), stride=(2, 2))
        # self.upsamp1 = nn.UpsamplingBilinear2d(2)
        self.relu3 = nn.ReLU(inplace=True)

        self.deconv4 = nn.ConvTranspose2d(256, 128, (3, 3), stride=(2, 2))
        # self.upsamp1 = nn.UpsamplingBilinear2d(2)
        self.relu4 = nn.ReLU(inplace=True)

        self.deconv5 = nn.ConvTranspose2d(128, 64, (3, 3), stride=(2, 2))
        # self.upsamp1 = nn.UpsamplingBilinear2d(2)
        self.relu5 = nn.ReLU(inplace=True)

        self.deconv6 = nn.ConvTranspose2d(64, 3, (3, 3), output_padding=1,stride=(2, 2))
        # self.upsamp1 = nn.UpsamplingBilinear2d(2)
        self.relu6 = nn.ReLU(inplace=True)
...
# summary(dec,input_size=(1024,2,2))
